...
common_corruptions = ['gaussian_noise', 'original', 'shot_noise', 'impulse_noise', 'defocus_blur', 'glass_blur',
                    'motion_blur', 'zoom_blur', 'snow', 'frost', 'fog',
                    'brightness', 'contrast', 'elastic_transform', 'pixelate', 'jpeg_compression']


def prepare_test_data(args):
    print('Preparing C-100 Test Data...')
    if args.dataset == 'cifar100':
        ...
        if args.corruption in common_corruptions:
            ...
            teset_ = torchvision.datasets.CIFAR100(root=args.dataroot,
...
def prepare_train_data(args):
    print('Preparing C-100 data...')
    if args.dataset == 'cifar100':
        trset = torchvision.datasets.CIFAR100(root=args.dataroot, transform=tr_transforms,
