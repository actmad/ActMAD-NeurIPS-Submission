...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('FF3838', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
               '2C99A8', '00C2FF', '344593', '6473FF', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8', 'FF37C7', 'FFFF00', '0000FF', 	'00ff00')
...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3):
    ...
    # cv2.imwrite(os.path.join('gt/', basename + '.png'), im)
...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16):
    ...
    for i, img in enumerate(images):
        ...
        # Image border
        # cv2.rectangle(mosaic, (block_x, block_y), (block_x + w, block_y + h), (0, 0, 255), thickness=1)
